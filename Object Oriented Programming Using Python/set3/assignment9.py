...
class Multiplex:
    ...
    def book_ticket(self, movie_name, number_of_tickets): 
        if(movie_name not in Multiplex.__list_movie_name): 
            ...
            mv_ind=Multiplex.__list_movie_name.index(movie_name)
            self.__seat_numbers=self.generate_seat_number(mv_ind,number_of_tickets)
            self.calculate_ticket_price(mv_ind,number_of_tickets)
    ...
    def generate_seat_number(self,movie_index, number_of_tickets): 
        ...
        if(Multiplex.__list_last_seat_number[movie_index]==None): 
            ...
            s=Multiplex.__list_last_seat_number[movie_index]
            k=s.index("-")+1
            #print(k)
            d=int(s[k:])
        #print(d)
        ...
        Multiplex.__list_last_seat_number[movie_index]=t[-1] 
        return t
