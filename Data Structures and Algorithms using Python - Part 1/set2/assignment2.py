...
class Performance: 
    ...
    def change_position(self,child): 
        ...
        while temp is not None: 
            k+=1 
            if k==s: 
                self.__children_list.insert(child,temp.get_next().get_data()) 
            temp=temp.get_next()
...
class Performance:
    ...
    def change_position(self,child):
        ...
        while temp is not None:
            ...
            temp=temp.get_next()
        m=len(l)//2
        self.__children_list.insert(child,l[m])
    
    def add_new_child(self,child):
        self.__children_list.insert(child,self.__children_list.get_tail().get_data())
