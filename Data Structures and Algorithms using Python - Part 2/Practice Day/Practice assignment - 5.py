"""
Problem Statement
Represent the trains to transport the goods as per the details given below: Train1 (Lokmanya) travels from Bangalore to Mumbai and train2 (Rajdhani) travels from Mumbai to Chandigarh. The passenger capacity of each compartment of train1 and train2 are 60 and 75 respectively.
