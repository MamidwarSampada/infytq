    ...
    if(food_type=="V"):
        if(quantity_ordered>0):
            if(distance_in_kms>6):
                bill_amount=quantity_ordered*120+9+((distance_in_kms-6)*6)
        ...
        if(quantity_ordered>0):
            if(distance_in_kms>6):
                bill_amount=quantity_ordered*150+9+((distance_in_kms-6)*6)
            elif(distance_in_kms>3):
...
if distance_in_kms<=3:
        ...
        charge=(distance_in_kms-3)*3
    else:
        charge=9+(distance_in_kms-6)*6
    if food_type=="N" and quantity_ordered>0 and distance_in_kms>0:
        bill_amount=150*quantity_ordered+charge
    elif food_type=="V" and quantity_ordered>0 and distance_in_kms>0:
        bill_amount=120*quantity_ordered+charge
    else:
        bill_amount=-1
